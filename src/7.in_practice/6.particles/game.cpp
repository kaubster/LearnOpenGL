...
void Game::Init()
{
	...
	ResourceManager::LoadShader(FileSystem::getPath("src/7.in_practice/6.particles/sprite.vs").c_str(), FileSystem::getPath("src/7.in_practice/6.particles/sprite.frag").c_str(), nullptr, "sprite");
	ResourceManager::LoadShader(FileSystem::getPath("src/7.in_practice/6.particles/particle.vs").c_str(), FileSystem::getPath("src/7.in_practice/6.particles/particle.frag").c_str(), nullptr, "particle");
